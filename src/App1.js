    ...
    <>
      <div className="aqi-website-Rok">
        <div className="group-427320195-ea2">
          <div className="auto-group-xcql-err">
            <div className="group-427320093-P3k">
              <div className="group-427320089-Fre">
                <div className="new-delhi--BEW">New Delhi :</div>
          ...
          <div className="auto-group-atfc-ofk">
            <div className="group-427319384-XLr">
              ...
              />
              <div className="search-location-9t2">Search Location</div>
            </div>
                ...
                <div className="group-427320198-tuU">
                  <div className="auto-group-bffc-QN2">
                    ...
                    <div className="auto-group-xcf8-de6">
                      <div className="new-delhi-Mpz">New Delhi</div>
        ...
        <div className="group-427320444-Y1c">
          ...
          <div className="auto-group-jwsv-QLe">
            <div className="group-427320440-uHQ">
              <div className="group-427320439-rCe">
                <div className="group-427320436-vCW">
                  <img className="vector-MYi" src="/images/vector-kpe.png" />
                  <img className="vector-tHk" src="/images/vector-Txi.png" />
                  <img className="vector-E6i" src="/images/vector-CSr.png" />
                  <img className="vector-xYW" src="/images/vector.png" />
                  <img className="vector-eAS" src="/images/vector-TU2.png" />
                  <img className="vector-n1k" src="/images/vector-vsQ.png" />
                  <img className="vector-7Jv" src="/images/vector-VU2.png" />
                  <img className="vector-epe" src="/images/vector-EGn.png" />
                  <img className="vector-ayC" src="/images/vector-BWv.png" />
                  <img className="vector-YoY" src="/images/vector-Gog.png" />
                  <img className="vector-Hm8" src="/images/vector-Ef8.png" />
                  <img className="vector-da6" src="/images/vector-x1C.png" />
                  <img className="vector-Nna" src="/images/vector-3g2.png" />
                  <img className="vector-7kA" src="/images/vector-dci.png" />
                  <img className="vector-3dp" src="/images/vector-Vbk.png" />
                  <img className="vector-nrJ" src="/images/vector-13C.png" />
                  <img className="vector-vhc" src="/images/vector-jQi.png" />
                  <img className="vector-4op" src="/images/vector-5wU.png" />
                  <img className="vector-caS" src="/images/vector-Xze.png" />
                  <img className="vector-wsc" src="/images/vector-MvW.png" />
                  <img className="vector-4hL" src="/images/vector-rmt.png" />
                  <img className="vector-oup" src="/images/vector-rz2.png" />
                  <img className="vector-9Tt" src="/images/vector-Rk2.png" />
                  <img className="vector-VGr" src="/images/vector-vh4.png" />
                  <img className="vector-cMU" src="/images/vector-SP8.png" />
                  <img className="vector-wuY" src="/images/vector-s6W.png" />
                  <img className="vector-VRG" src="/images/vector-omx.png" />
                  <img className="vector-qEE" src="/images/vector-3ok.png" />
                  <img className="vector-ybL" src="/images/vector-R9Q.png" />
                  <img className="vector-iYv" src="/images/vector-7Rp.png" />
                  <img className="vector-rQE" src="/images/vector-Dgz.png" />
                  <img className="vector-Pux" src="/images/vector-Jdk.png" />
                  <img className="vector-K2v" src="/images/vector-Bw4.png" />
                  <img className="vector-FBU" src="/images/vector-1Mx.png" />
                  <img className="vector-nhC" src="/images/vector-BXL.png" />
                  <img className="vector-jMY" src="/images/vector-ijQ.png" />
                  <img className="vector-H8A" src="/images/vector-Mzv.png" />
                  <img className="vector-cgE" src="/images/vector-KXk.png" />
                  <img className="vector-ASr" src="/images/vector-1bU.png" />
                  <img className="vector-VEE" src="/images/vector-WcW.png" />
                  <img className="vector-zwg" src="/images/vector-sCi.png" />
                  <img className="vector-v4e" src="/images/vector-DMg.png" />
                  <img className="vector-eFY" src="/images/vector-7yp.png" />
                  <p className="pm25-YLv">PM2.5</p>
                </div>
                <div className="pm25-dNN">PM2.5</div>
                <div className="group-427320290-wP4">
                  <div className="item-344-4Cn">344</div>
                  <div className="g-m3-agv">
                    <span className="g-m3-agv-sub-0">μg/m</span>
              ...
              <img
                className="exclamation-mark-svgrepo-com-1-vGv"
                src="/images/exclamation-mark-svgrepo-com-1.png"
              />
            </div>
            <div className="auto-group-rcja-36e">
              <div className="group-427320443-xjQ">
                <div className="pm10-f82">
                  <div className="group-22-NYE">
                    <img className="vector-sUz" src="/images/vector-vE2.png" />
                    <img className="vector-1bC" src="/images/vector-vSA.png" />
                    <img className="vector-9hQ" src="/images/vector-XZY.png" />
                    <img className="vector-Hoc" src="/images/vector-VVG.png" />
                    <img className="vector-ED4" src="/images/vector-b5p.png" />
                    <img className="vector-yAe" src="/images/vector-HUz.png" />
                    <img className="vector-iP8" src="/images/vector-qcA.png" />
                    <img className="vector-3wC" src="/images/vector-6iz.png" />
                    <img className="vector-zbY" src="/images/vector-RCJ.png" />
                    <img className="vector-8Bx" src="/images/vector-88e.png" />
                    <img className="vector-F1g" src="/images/vector-fEn.png" />
                    <img className="vector-b5Y" src="/images/vector-NDt.png" />
                    <img className="vector-Xzn" src="/images/vector-tgN.png" />
                    <img className="vector-GxN" src="/images/vector-gqL.png" />
                    <img className="vector-2Rk" src="/images/vector-Gyt.png" />
                    <img className="vector-Myp" src="/images/vector-ydY.png" />
                    <img className="vector-JeA" src="/images/vector-gFg.png" />
                    <img className="vector-SkN" src="/images/vector-2rJ.png" />
                    <img className="vector-zWz" src="/images/vector-yEv.png" />
                    <img className="vector-jUa" src="/images/vector-YDt.png" />
                    <img className="vector-g8v" src="/images/vector-zyt.png" />
                    <img className="vector-pW2" src="/images/vector-ZnW.png" />
                    <img className="vector-LzA" src="/images/vector-o5g.png" />
                    <img className="vector-VMG" src="/images/vector-Qfg.png" />
                    <img className="vector-EZk" src="/images/vector-g7g.png" />
                    <img className="vector-PBk" src="/images/vector-DuQ.png" />
                    <img className="vector-8QE" src="/images/vector-T5G.png" />
                    <p className="pm10-HH8">PM10</p>
                  </div>
                </div>
                <div className="pm10-an2">PM10</div>
                <div className="group-427320290-71G">
                  <div className="item-344-28E">344</div>
                  <div className="g-m3-Luc">
                    <span className="g-m3-Luc-sub-0">μg/m</span>
                    <span className="g-m3-Luc-sub-1">3</span>
                  </div>
                </div>
                <div className="rectangle-34624663-RJn"></div>
              </div>
              <div className="group-427320438-uDx">
                <div className="o3-Ava">
                  <img className="vector-tbg" src="/images/vector-mq8.png" />
                  <div className="auto-group-ju7q-azJ">
                    <img className="vector-hp2" src="/images/vector-39G.png" />
                    <img className="vector-REE" src="/images/vector-Y7Q.png" />
                    <img className="vector-XHG" src="/images/vector-M2e.png" />
                    <p className="o-R7k">O₃</p>
                  </div>
                </div>
                <div className="o3-TKL">O3</div>
                <div className="group-427320290-j1x">
                  <div className="item-344-ygz">344</div>
                  <div className="ppb-Ts4">ppb</div>
                </div>
                <div className="rectangle-34624663-zMC"></div>
              </div>
            </div>
          </div>
          <div className="auto-group-mcfg-H5Q">
            <div className="group-427320441-BAn">
              <div className="frame-VBU">CO</div>
              <div className="co-A2i">CO</div>
              <div className="group-427320290-TnW">
                <div className="item-344-zXY">344</div>
                <div className="ppm-WVt">ppm</div>
              </div>
              <div className="rectangle-34624663-3Ev"></div>
            </div>
            <div className="group-427320442-8nA">
              <div className="no2-ekW">
                <img className="vector-zZU" src="/images/vector-fzE.png" />
                <div className="auto-group-rguk-Kre">
                  <img className="vector-s7U" src="/images/vector-RXU.png" />
                  <img className="vector-QdC" src="/images/vector-g5U.png" />
                  <p className="no2-MHY">
                    <span className="no2-MHY-sub-0">NO</span>
                    <span className="no2-MHY-sub-1">2</span>
                  </p>
                  <img className="vector-8xW" src="/images/vector-TcA.png" />
                  <img className="vector-UWa" src="/images/vector-Ld4.png" />
                  <img className="vector-paS" src="/images/vector-oHQ.png" />
                </div>
              </div>
              <div className="no2-ifp">NO2</div>
              <div className="group-427320290-dGz">
                <div className="item-344-kcW">344</div>
                <div className="ppb-5en">ppb</div>
              </div>
              <div className="rectangle-34624663-p6a"></div>
            </div>
            <div className="group-427320437-Kp2">
              <div className="so2-Evz">
                <img className="vector-xc6" src="/images/vector-shg.png" />
                <div className="auto-group-hohq-6TQ">
                  <img className="vector-S1U" src="/images/vector-wPC.png" />
                  <img className="vector-k2A" src="/images/vector-2hC.png" />
                  <p className="so2-rL6">
                    <span className="so2-rL6-sub-0">SO</span>
                    <span className="so2-rL6-sub-1">2</span>
                  </p>
                  <img className="vector-f2e" src="/images/vector-akN.png" />
                  <img className="vector-Bmg" src="/images/vector-z8e.png" />
                  <img className="vector-K7C" src="/images/vector-cYN.png" />
                </div>
              </div>
              <div className="so2-2XQ">SO2</div>
              <div className="group-427320290-kCW">
                <div className="item-344-mtJ">344</div>
                <div className="ppb-J7Y">ppb</div>
              </div>
              <div className="rectangle-34624663-pra"></div>
            </div>
          </div>
          ...
          <div className="auto-group-8qjt-76v">
            <div className="group-427320305-dLA">
              ...
              <p className="mostly-sunny-LbG">Mostly Sunny</p>
            ...
            <div className="rectangle-34624663-RFL"></div>
            <div className="group-427320306-H2e">
              <p className="tuesday-1DY">Tuesday</p>
              <div className="auto-group-vthq-XBt">
                <img className="item-22-1-fJ6" src="/images/-JwQ.png" />
                <div className="group-427320303-BnE">
                  <div className="group-427319213-8xN">
                    <p className="item-35-68W">35</p>
                    <p className="o-d8S">O</p>
                  </div>
                  <img
                    className="vector-687-Z26"
                    src="/images/vector-687-1Xk.png"
                  />
                  <div className="group-427319217-Gx6">
                    <p className="item-5-pii">5</p>
                    <p className="o-ZwC">O</p>
                    <p className="c-K9g">C</p>
                  </div>
                </div>
              </div>
              <p className="rainy-qdp">Rainy</p>
              <div className="group-427320304-xiS">
                <img
                  className="droplets-01-svgrepo-com-1-hR8"
                  src="/images/droplets-01-svgrepo-com-1-59Y.png"
                />
                <p className="item-70--Rc2">70 %</p>
              </div>
            </div>
            <div className="rectangle-34624664-Mka"></div>
            <div className="group-427320307-2ri">
              <p className="wednesday-y1G">Wednesday</p>
              <div className="auto-group-cjby-HGr">
                <div className="group-427320302-Cuc">
                  <img className="item-26-38-up2" src="/images/-4zz.png" />
                  <img className="item-26-39-qxa" src="/images/-QrJ.png" />
                </div>
                <div className="group-427320303-mLS">
                  <div className="group-427319213-7fC">
                    <p className="item-35-56E">35</p>
                    <p className="o-CwY">O</p>
                  </div>
                  <img
                    className="vector-687-jga"
                    src="/images/vector-687-cHC.png"
                  />
                  <div className="group-427319217-fKL">
                    <p className="item-5-D5x">5</p>
                    <p className="o-xZL">O</p>
                    <p className="c-uUa">C</p>
                  </div>
                </div>
              </div>
              <p className="mostly-sunny-3Kt">Mostly Sunny</p>
              <div className="group-427320304-kzz">
                <img
                  className="droplets-01-svgrepo-com-1-HEE"
                  src="/images/droplets-01-svgrepo-com-1-TJn.png"
                />
                <p className="item-70--C6J">70 %</p>
              </div>
            </div>
            <div className="rectangle-34624665-XPU"></div>
            <div className="group-427320308-Biv">
              <p className="thursday-KKL">Thursday</p>
              <div className="auto-group-nkkr-Ex6">
                <img className="item-22-1-PKC" src="/images/-Cir.png" />
                <div className="group-427320303-i6a">
                  <div className="group-427319213-fGi">
                    <p className="item-35-DJE">35</p>
                    <p className="o-wk2">O</p>
                  </div>
                  <img
                    className="vector-687-gxW"
                    src="/images/vector-687-gmL.png"
                  />
                  <div className="group-427319217-2Fg">
                    <p className="item-5-Acn">5</p>
                    <p className="o-7Y2">O</p>
                    <p className="c-s1Q">C</p>
                  </div>
                </div>
              </div>
              <p className="rainy-o9x">Rainy</p>
              <div className="group-427320304-w1G">
                <img
                  className="droplets-01-svgrepo-com-1-ewG"
                  src="/images/droplets-01-svgrepo-com-1-kVU.png"
                />
                <p className="item-70--yyY">70 %</p>
              </div>
            </div>
            <div className="rectangle-34624666-XEN"></div>
            <div className="group-427320309-Nkn">
              <p className="friday-7TU">Friday</p>
              <div className="auto-group-mcy4-Enz">
                <img className="item-28-1-ZaN" src="/images/-AM4.png" />
                <div className="group-427320303-tMk">
                  <div className="group-427319213-dq8">
                    <p className="item-35-Zin">35</p>
                    <p className="o-5BL">O</p>
                  </div>
                  <img
                    className="vector-687-D2e"
                    src="/images/vector-687-ynn.png"
                  />
                  <div className="group-427319217-jWn">
                    <p className="item-5-HHQ">5</p>
                    <p className="o-ETY">O</p>
                    <p className="c-kgn">C</p>
                  </div>
                </div>
              </div>
              <p className="thunderstorm-V8a">Thunderstorm</p>
              <div className="group-427320304-DKU">
                <img
                  className="droplets-01-svgrepo-com-1-Lez"
                  src="/images/droplets-01-svgrepo-com-1-7QA.png"
                />
                <p className="item-70--s98">70 %</p>
              </div>
            </div>
            <div className="rectangle-34624667-PtA"></div>
            <div className="group-427320310-Gh4">
              <p className="saturday-ogz">Saturday</p>
              <div className="auto-group-9fka-wHQ">
                <div className="group-427320302-G4n">
                  <img className="item-26-38-b74" src="/images/.png" />
                  <img className="item-26-39-ixN" src="/images/-HQr.png" />
                </div>
                <div className="group-427320303-FSW">
                  <div className="group-427319213-bmG">
                    <p className="item-35-keA">35</p>
                    <p className="o-gXp">O</p>
                  </div>
                  <img
                    className="vector-687-dCA"
                    src="/images/vector-687-vWA.png"
                  />
                  <div className="group-427319217-9wC">
                    <p className="item-5-6bY">5</p>
                    <p className="o-3Wn">O</p>
                    <p className="c-Bcz">C</p>
                  </div>
                </div>
              </div>
              <p className="mostly-sunny-isp">Mostly Sunny</p>
              <div className="group-427320304-T4i">
                <img
                  className="droplets-01-svgrepo-com-1-NhU"
                  src="/images/droplets-01-svgrepo-com-1-Q7p.png"
                />
                <p className="item-70--hUr">70 %</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <p className="new-delhi-india-A86">New Delhi, India</p>
